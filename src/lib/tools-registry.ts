...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    shortTitle: "Material",
    description:
      "Browse Google Material Design palettes with shade scales, HEX/RGB/HSL copy, CSS variables, and contrast inspector.",
  ...
  },
  {
    ...
    shortTitle: "Tailwind",
    description:
      "Complete Tailwind CSS color scales with live inspector, format switching, and one-click scale export.",
  ...
  },
  {
    ...
    shortTitle: "Wheel",
    description:
      "Interactive color wheel with a lightness ring, locked harmony chords, and copy-ready palettes — complementary, analogous, triadic, tetradic, square, and more.",
    keywords: ["color wheel", "color circle", "color theory", "color harmony", "complementary colors", "analogous colors"],
    category: "pickers",
    icon: "CircleDot",
    popular: true,
  ...
  },
  {
    ...
    keywords: ["glassmorphism generator", "glass css", "frosted glass", "glassmorphism", "backdrop blur"],
    category: "css-generators",
    icon: "Sparkles",
    featured: true,
  ...
  },
  {
    ...
    description:
      "Build soft UI neumorphism with light angle, raised/pressed/convex/concave modes, shapes, hover/active states, and copyable box-shadow CSS.",
    keywords: ["neumorphism generator", "soft ui", "neomorphic css", "neumorphism", "soft shadow"],
    category: "css-generators",
    icon: "Layers",
  ...
  },
  {
    ...
    shortTitle: "Buttons",
    description:
      "Design CSS buttons with solid, outline, soft, gradient, neon, 3D, and more presets — plus fonts, typography, icons, hover/focus/disabled states, and export-ready CSS.",
    keywords: [
    ...
    related: ["box-shadow-generator", "css-animation-generator", "css-border-radius-generator"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Build CSS keyframe animations with heart, star, and other shapes, 16 motion presets, timing/easing controls, play/pause preview, and IDE-ready CSS with reduced-motion support.",
    keywords: [
    ...
    category: "css-generators",
    icon: "Film",
    related: ["css-transition-generator", "css-transform-generator", "css-button-generator"],
  },
  {
  ...
  },
  {
    ...
    shortTitle: "Brands",
    description:
      "Official brand hex color codes for Google, Apple, Spotify, Netflix, Nike, Facebook, and 70+ companies. Copy logo HEX, RGB, and CSS.",
    keywords: ["brand colors", "company colors", "logo colors", "brand hex", "hex color code"],
    category: "inspiration",
    icon: "BadgeCheck",
...
export const STATIC_PAGES = [
  ...
  { slug: "color-names", title: "Color Names", description: "Wheat, salmon, tomato, and every CSS named color with hex codes." },
