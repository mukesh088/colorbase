...
export const TOOLS: ToolDefinition[] = [
  {
    ...
    shortTitle: "Picker",
    description:
      "Advanced HTML color picker with EyeDropper API, HEX, RGB, HSL, HSV, and CMYK formats. Copy and save favorite colors.",
    keywords: ["color picker", "html color picker", "eyedropper", "hex picker"],
    category: "pickers",
    icon: "Pipette",
    featured: true,
    popular: true,
    related: ["hex-to-rgb", "contrast-checker", "palette-generator"],
  },
  {
    slug: "hex-to-rgb",
  ...
  },
  {
    ...
    description:
      "Create CSS clip-path shapes visually. Polygon, circle, ellipse, and inset presets.",
