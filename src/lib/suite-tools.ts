...
export const SUITE_TOOLS: ToolDefinition[] = [
  ...
  t("backdrop-filter-generator", "Backdrop Filter Generator", "Backdrop", "Generate CSS backdrop-filter effects: blur, brightness, contrast, grayscale, hue-rotate, invert, opacity, saturate, sepia, and drop-shadow — with live frosted-glass preview.", "css-generators", ["backdrop-filter", "frosted glass", "css backdrop filter"], "Sparkles", ["glassmorphism-generator", "css-filter-generator"]),
