...
export const SUITE_TOOLS: ToolDefinition[] = [
  ...
  t("svg-optimizer", "SVG Optimizer", "SVG Opt", "Optimize and minify SVG in the browser with live preview, SVGO-style plugins, gzip size compare, copy or download.", "image", ["svg optimizer", "svgo", "svgomg", "minify svg", "compress svg", "optimize svg"], "FileCode2", ["image-compressor", "image-to-base64"]),
